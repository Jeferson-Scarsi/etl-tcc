...
def dim_cliente():
    ...
    df = df.sort_values(by=['id_cliente', 'cpf_cnpj', 'cidade', 'estado', 'cd_origem_sistema', 'cd_execucao'], ascending=True)
    ...
    df = df[['id_cliente', 'cpf_cnpj', 'cidade_cliente', 'estado', 'cd_origem_sistema', 'cd_execucao']]
