...
def dim_pagamento():
    ...
    df = df.sort_values(by=['tipo_pagamento', 'cd_origem_sistema'], ascending=True)

    # 5 - Remove as linhas duplicadas com base na coluna tipo_pagamento.
    ...
    df = df[['tipo_pagamento', 'cd_origem_sistema', 'cd_execucao']]
